...
const AddToCartButton: React.FC<AddToCartButtonProps> = ({
  ...
  const handleAddToCart = () => {
    ...
    if (productIndex !== -1) {
      cart[productIndex].quantity += quantity; // <-- Use quantity here
    } else {
      cart.push({
        ...product,
        variantId: variantId,
        price: selectedVariant ? selectedVariant.price : product.price,
        quantity: quantity, // <-- Use quantity here
        variation: selectedVariant ? [selectedVariant] : [],
      });
    }
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 sm:gap-12 md:gap-16">
        ...
        <div className="flex flex-col gap-4 sm:gap-6 md:gap-8 md:w-[50%]">
          ...
          <div className="flex flex-col gap-1 sm:gap-2 md:gap-3">
            ...
            <div className="my-1 md:my-2 flex items-center gap-2 sm:gap-3 md:gap-4">
              <button
